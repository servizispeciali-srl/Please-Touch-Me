...
public class UniversalVideoView extends SurfaceView
        implements OrientationDetector.OrientationChangeListener{
    ...
    private void openVideo() {
        ...
        try {
            ...
            Log.l(1, "Unable to open content: " + mUri);
    ...
    MediaPlayer.OnVideoSizeChangedListener mSizeChangedListener =
            new MediaPlayer.OnVideoSizeChangedListener() {
                public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
                    ...
                    Log.l(1, String.format("onVideoSizeChanged width=%d,height=%d", mVideoWidth, mVideoHeight));
                    if (mVideoWidth != 0 && mVideoHeight != 0) {
                ...
                public  boolean onInfo(MediaPlayer mp, int what, int extra){
                    ...
                    switch (what) {
                        case MediaPlayer.MEDIA_INFO_BUFFERING_START:
                            Log.l(1, "onInfo MediaPlayer.MEDIA_INFO_BUFFERING_START");
                        ...
                        case MediaPlayer.MEDIA_INFO_BUFFERING_END:
                            Log.l(1, "onInfo MediaPlayer.MEDIA_INFO_BUFFERING_END");
                            if (videoViewCallback != null) {
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
            new MediaPlayer.OnErrorListener() {
                public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
                    Log.l(1, "Error: " + framework_err + "," + impl_err);
                    mCurrentState = STATE_ERROR;
                    mTargetState = STATE_ERROR;
